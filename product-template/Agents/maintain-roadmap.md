...
**PM-only** (`disable-model-invocation: true`).

**Modes:** Bootstrap (no `Features/*/scope.yaml`) vs Maintain (regenerate `Context/roadmap-snapshot.md`).
...
**Invoke:** "Update the {{PRODUCT_NAME}} roadmap."

**Invoke:** "Update the product roadmap from master.yaml and Progress."
