...
- Short note: which WholeLoop agents depend on what you set (spec-review, planner, builder, …).

## How this file affects other agents

| Agent | Uses conventions for |
|-------|----------------------|
| spec-review | Tracker provider, spec ↔ epic linking, stack constraints, product repo path |
| planner | Allowed paths, release strategy, story/plan layout |
